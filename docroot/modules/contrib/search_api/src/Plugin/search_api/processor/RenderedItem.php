  ...
  public function addFieldValues(ItemInterface $item) {
    ...
    foreach ($fields as $field) {
      ...
      if (\Drupal::moduleHandler()->moduleExists('language')
        ...
        // The string_translation service is initialized with the default
        // language, so we need to update this as well.
        /** @var \Drupal\Core\StringTranslation\TranslationManager $translationManager */
        $translationManager = \Drupal::service('string_translation');
