...
(function ($, Drupal, window, document) {
  ...
  self.layoutResets = function(layouts) {
    ...
    once('js-once-layouts-resets', layouts).forEach(function(layoutElement) {

      var layout = $(layoutElement);

      once('js-once-layout-reset', layout).each(function(layoutItemElement) {

        var layoutItem = $(layoutItemElement),
          p = layoutItem,
