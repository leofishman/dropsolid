...
(function ($, Drupal, window, document) {
  ...
  self.setresponsiveTables = function(tables) {
    ...
    once('js-once-set-responsive-tables', tables).forEach(function(tableElement) {
  ...
  self.tableScroll = function(table, wrapper) {
    ...
    // loop rows
    once('js-once-check-th-position', trs).forEach(function(trElement, i) {
      ...
      once('js-once-check-th-position', ths).forEach(function(thElement, j) {
