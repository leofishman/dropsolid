...
(function ($, Drupal, window, document) {
  ...
  Drupal.behaviors.rocketshipUIBase = {
    attach: function (context, settings) {
      ...
      if (skipLink.length && content.length) {
        ...
        once('js-once-skip-link', skipLink).forEach(function(linkElement) {
  ...
  self.cardLink = function(elements, linkSelector, fallbackSelector) {
    ...
    once('js-once-cardlink', elements).forEach(function(element) {
      ...
      if (typeof link !== 'undefined' && link !== null && link.length) {
        ...
        once('js-once-cardlink-mousedown', el).forEach(function (el) {
        ...
        once('js-once-cardlink-mouseup', el).forEach(function (el) {
  ...
  self.scrollToAnchor = function(offset) {
    ...
    if (animatedScrolling) {
      ...
      if ( $(urlHash).length ) {
        ...
        once('js-once-scrollable-anchors-active', myAnchorLinks).forEach(function(linkElement) {
      ...
      once('js-once-scrollable-anchors', anchorLinks).forEach(function(linkElement) {
        ...
        once('js-once-scrollable-anchor-click', anchorLink).forEach(function (linkElement) {
      ...
      window.onpopstate = function(event) {
        ...
        once('js-once-scrollable-anchors-popstate', anchorLinks).forEach(function(linkElement) {
